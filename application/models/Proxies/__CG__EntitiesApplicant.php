 ...
 */
class Applicant extends \Entities\Applicant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Applicant' . "\0" . 'id', '' . "\0" . 'Entities\\Applicant' . "\0" . 'name', '' . "\0" . 'Entities\\Applicant' . "\0" . 'businesstitle', '' . "\0" . 'Entities\\Applicant' . "\0" . 'mobile', '' . "\0" . 'Entities\\Applicant' . "\0" . 'email', '' . "\0" . 'Entities\\Applicant' . "\0" . 'addressline', '' . "\0" . 'Entities\\Applicant' . "\0" . 'city', '' . "\0" . 'Entities\\Applicant' . "\0" . 'district', '' . "\0" . 'Entities\\Applicant' . "\0" . 'state', '' . "\0" . 'Entities\\Applicant' . "\0" . 'pin', '' . "\0" . 'Entities\\Applicant' . "\0" . 'dob', '' . "\0" . 'Entities\\Applicant' . "\0" . 'ma', '' . "\0" . 'Entities\\Applicant' . "\0" . 'registeredon', '' . "\0" . 'Entities\\Applicant' . "\0" . 'notes');
        }
    ...
    public function setAddressline($addressline)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAddressline', array($addressline));
    ...
    public function getAddressline()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAddressline', array());
