...
--
-- Host: localhost
-- Generation Time: Jul 22, 2015 at 04:50 AM
...
CREATE TABLE IF NOT EXISTS `plan` (
  ...
  `minesId` int(4) unsigned NOT NULL,
...
ALTER TABLE `plan`
  ...
  ADD CONSTRAINT `plan_ibfk_2` FOREIGN KEY (`minesId`) REFERENCES `mines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
